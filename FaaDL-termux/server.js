...
// Hasil download: /sdcard/Download/FaaDL (butuh `termux-setup-storage` sekali).
// Fallback ke folder downloads/ lokal bila /sdcard tidak ada.
const SDCARD_DIR = '/sdcard/Download/FaaDL';
const LOCAL_DIR = path.join(__dirname, 'downloads');
const DOWNLOAD_DIR = fs.existsSync('/sdcard') ? SDCARD_DIR : LOCAL_DIR;
